...
export default function IndexPage({ latestArticles, latestProjects }) {
  return (
    <div className="mt-16 font-sans md:mt-32">
      <section className="w-full max-w-6xl px-4 mx-auto md:px-0 md:grid md:grid-flow-row md:grid-cols-2 md:gap-4">
      ...
      <section className="px-4 md:px-0" id="recent_projects">
