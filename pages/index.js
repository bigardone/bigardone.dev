...
export default function IndexPage({ latestArticles, latestProjects }) {
  return (
    <div className="md:mt-32 mt-16 font-sans">
      <section className="md:grid md:grid-flow-row md:grid-cols-2 md:gap-4 w-full max-w-6xl px-4 mx-auto">
        <div className="md:mb-0 mb-6 text-xl leading-relaxed text-gray-700">
          <p className="font-black">
            Hi, how are you doing? I'm Ricardo.
          </p>
          <h1 className="text-purple-1000 my-8 text-4xl font-black">
          ...
          <p>
            ...
            {' '}
            <a href="#latest_articles" className="hover:underline font-black text-purple-700">latest articles</a>
            {' '}
            or take a look at my
            {' '}
            <a href="#recent_projects" className="hover:underline font-black text-purple-700">recent projects</a>
            . I hope you enjoy them. 🙌
          </p>
        </div>
        <div className="md:justify-end flex flex-row justify-center w-auto">
          <div className="md:w-auto w-3/4">
            <Image
      ...
      <section className="bg-purple-50" id="latest_articles">
        <div className="max-w-6xl px-4 mx-auto">
          ...
          <div className="grid grid-flow-row md:grid-cols-2 grid-cols-1 gap-8">
            ...
            <div>
              <a href="/blog" className="shadow-custom hover:underline hover:shadow-custom-hover block p-8 font-black text-center text-purple-900 bg-purple-200 rounded-lg">
                View more articles
              </a>
            </div>
          </div>
